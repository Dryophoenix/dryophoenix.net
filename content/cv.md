...
- Ran sessions and handled signal flow on the department's 48-channel Audient console, maintaining it alongside the studio's software environment.
...
### Salem World Beat Festival — Stepping Stage Sound Engineer
*2024, 2025, 2026*

- Set the stage for artists performing at the festival, ensuring a correct setup with minimal time available.
- Managed correct audio levels throughout artists' performances, allowing the audience to have an enjoyable listening experience.
- Live-mixed sets up to ten tracks on an analog 12-track board.
